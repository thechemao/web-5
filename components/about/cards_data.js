...
[
  ...
  },
  {
    title: "Formación",
    items: [
      { name: "Grado Superior ASIR", icon: "", descripcion: ""},
      { name: "Grado medio SMR", icon: "", descripcion: ""},
      { name: "Cisco - Packet Tracer", icon: "", descripcion: ""},
      { name: "Riesgos laborales", icon: "", descripcion: ""},
      { name: "Linux Essentials", icon: "", descripcion: ""},
      { name: "Networking Essentials", icon: "", descripcion: ""},
      { name: "Manipulador de Alimentos", icon: "", descripcion: ""},
    ]
  },
  {
    title: "Idiomas",
